...
namespace IBS.Models.ViewModels
{
    ...
    {
        [Display(Name = "JV No")] public string? JVNo { get; set; }
        ...
        [Display(Name = "CV Id")] public int? CVId { get; set; }
        ...
        [NotMapped] public List<SelectListItem>? Employees { get; set; }

        public string Particulars { get; set; } = null!;

        [Display(Name = "PR No")] public string? PRNo { get; set; }

        [NotMapped] public List<SelectListItem>? ProvisionalReceipts { get; set; }

        [Display(Name = "JV Reason")] public string JVReason { get; set; } = null!;
