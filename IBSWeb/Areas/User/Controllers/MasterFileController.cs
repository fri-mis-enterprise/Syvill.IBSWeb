...
namespace IBSWeb.Areas.User.Controllers
{
    ...
    public class MasterFileController: Controller
    {
        ...
        public async Task<IActionResult> GenerateExcel(string masterFileType, CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                var safeMasterFileTypeForLog = masterFileType?
                    ...
                    .Replace("\n", " ");
                _logger.LogError(ex,
                    "Failed to generate {MasterFileType} master file excel. Error: {ErrorMessage}, Stack: {StackTrace}. Generated by: {UserName}",
            ...
            if (branches.Any())
            {
                var branchColumns = new List<ColumnDefinition>
                {
                    new()
                    {
                        ...
                        ValueSelector = b => ((CustomerBranch)b).Customer?.CustomerName
                    },
                ...
                {
                    { "CUSTOMER NAME", 30 }, { "BRANCH NAME", 30 }, { "BRANCH ADDRESS", 100 }
                };
            ...
            CancellationToken cancellationToken)
        {
            ...
            var customWidths = new Dictionary<string, double> { { "SUPPLIER NAME", 60 }, { "SUPPLIER ADDRESS", 120 } };
            ...
            CancellationToken cancellationToken)
        {
            ...
            var customWidths = new Dictionary<string, double> { { "ACCOUNT NAME", 40 }, { "BRANCH", 80 } };
            ...
            CancellationToken cancellationToken)
        {
            ...
            var customWidths = new Dictionary<string, double> { { "SERVICE NAME", 30 }, };
            ...
            CancellationToken cancellationToken)
        {
            ...
            var columns = new List<ColumnDefinition>
            {
                ...
                new()
                {
                    Header = "BIRTH DATE", ValueSelector = e => ((Employee)e).BirthDate, NumberFormat = "mm/dd/yyyy"
                },
                ...
                new()
                {
                    Header = "DATE HIRED", ValueSelector = e => ((Employee)e).DateHired, NumberFormat = "mm/dd/yyyy"
                },
                new()
                {
                    Header = "DATE RESIGNED",
                    ValueSelector = e => ((Employee)e).DateResigned?.ToDateTime(TimeOnly.MinValue),
            ...
            {
                { "SERVICE NAME", 30 }, { "ADDRESS", 100 }, { "PHILHEALTH NO", 40 },
            };
